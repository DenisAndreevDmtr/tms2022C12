...
public class Main {
    public static void main(String[] args) {
        Person pers1 = new Person("Ivan", 19, "male", new Address("Belarus", "Minsk"));
        Person pers2 = new Person("Alex", 26, "male", new Address("Belarus", "Minsk"));
        Person pers3 = new Person("Alex", 28, "male", new Address("Belarus", "Vitebsk"));
        Person pers4 = new Person("Petr", 25, "male", new Address("Belarus", "Minsk"));
        Person pers5 = new Person("Vladimir", 19, "male", new Address("Belarus", "Grodno"));
        Person pers6 = new Person("Oksana", 21, "female", new Address("Belarus", "Minsk"));
        Person pers7 = new Person("Alex", 17, "male", new Address("Belarus", "Minsk"));
        ...
        list1.printRecruitFromCity("Minsk");
