...
<div class="container">
    <div class="col-md-8 offset-md-4">
        ...
        <form method="post" action="${contextPath}/eshop?command=status_register" class="needs-validation" novalidate>
            ...
            <%--                <div>--%>
            <%--                    <a href="${contextPath}/eshop?command=status_register">Register</a>--%>
            <%--                </div>--%>
